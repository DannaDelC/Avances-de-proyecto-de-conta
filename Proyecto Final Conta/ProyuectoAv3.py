...
class PuntoEquilibrioApp:
    def __init__(self, master):
        ...
        master.configure(bg="#e0f7fa")  # Fondo azul claro
        ...
        # Título principal
        self.label_title = tk.Label(master, text="Calculadora de Punto de Equilibrio", font=("Arial", 16, "bold"), bg="#00acc1", fg="white")
        self.label_title.grid(row=0, column=0, columnspan=2, pady=10)

        # Etiqueta y campo de entrada para Costos Fijos
        self.label_cf = tk.Label(master, text="Costos Fijos (Q):", font=("Arial", 12), bg="#e0f7fa")
        ...
        self.label_pu = tk.Label(master, text="Precio Unitario (Q):", font=("Arial", 12), bg="#e0f7fa")
        ...
        self.label_cv = tk.Label(master, text="Costo Variable por Unidad (Q):", font=("Arial", 12), bg="#e0f7fa")
        ...
        self.button_calculate = tk.Button(master, text="Calcular Punto de Equilibrio", command=self.calcular_y_graficar, font=("Arial", 12), bg="#00acc1", fg="white")
        self.button_calculate.grid(row=4, column=0, columnspan=2, pady=10)

        # Etiqueta para mostrar los resultados
        self.result_label = tk.Label(master, text="", font=("Arial", 12), bg="#e0f7fa", fg="green")
    ...
    def graficar_punto_equilibrio(self, costos_fijos, precio_unitario, costo_variable):
        ...
        # Generar la gráfica
        self.ax.plot(unidades, ingresos, label='Ingresos', color='blue')
        self.ax.plot(unidades, costos, label='Costos', color='orange')
        self.ax.axvline(x=costos_fijos / (precio_unitario - costo_variable), color='red', linestyle='--', label='Punto de Equilibrio')
        self.ax.set_xlabel('Unidades Vendidas', fontsize=12)
        self.ax.set_ylabel('Quetzales', fontsize=12)
        self.ax.set_title('Análisis de Punto de Equilibrio', fontsize=14)
        self.ax.legend()
        self.ax.grid(True)
...
if __name__ == "__main__":
    root = tk.Tk()
    root.geometry("600x600")  # Ajusta el tamaño de la ventana si es necesario
